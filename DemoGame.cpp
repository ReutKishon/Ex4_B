...
namespace WarGame {
		...
		uint DemoGame::play() {
			...
			board.move(1, {0,2}, Board::MoveDIR::Left);      // FootCommander of player 1 moves forward from {0,3} to {1,3}, and all soldiers of player 1 attack.
			if (!board.has_soldiers(2)) return 1;
